...
- Backend server running on `https://api.carecompapp.com`
- MongoDB connected
...
```bash
curl https://api.carecompapp.com/onboarding/get-all-applications
```
...
curl -X GET https://api.carecompapp.com/onboarding/get-application/EMPLOYEE_ID
```
...
```bash
# Save as Draft
curl -X POST https://api.carecompapp.com/onboarding/save-employment-application \
...
curl -X GET https://api.carecompapp.com/onboarding/get-employment-application/APPLICATION_ID
```
...
```bash
# Save I-9 Form
curl -X POST https://api.carecompapp.com/onboarding/save-i9-form \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
# Get I-9 Form
curl -X GET https://api.carecompapp.com/onboarding/get-i9-form/APPLICATION_ID
```
...
```bash
# Save W-4 Form
curl -X POST https://api.carecompapp.com/onboarding/save-w4-form \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
# Get W-4 Form
curl -X GET https://api.carecompapp.com/onboarding/get-w4-form/APPLICATION_ID
```
...
```bash
# Save W-9 Form
curl -X POST https://api.carecompapp.com/onboarding/save-w9-form \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
# Get W-9 Form
curl -X GET https://api.carecompapp.com/onboarding/get-w9-form/APPLICATION_ID
```
...
curl -X POST https://api.carecompapp.com/onboarding/save-emergency-contact \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
curl -X GET https://api.carecompapp.com/onboarding/get-emergency-contact/APPLICATION_ID
```
...
```bash
# Save Direct Deposit
curl -X POST https://api.carecompapp.com/onboarding/save-direct-deposit \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
# Get Direct Deposit
curl -X GET https://api.carecompapp.com/onboarding/get-direct-deposit/APPLICATION_ID
```
...
curl -X POST https://api.carecompapp.com/onboarding/save-misconduct-statement \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
curl -X GET https://api.carecompapp.com/onboarding/get-misconduct-statement/APPLICATION_ID
```
...
```bash
# Save Code of Ethics
curl -X POST https://api.carecompapp.com/onboarding/save-code-of-ethics \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
# Get Code of Ethics
curl -X GET https://api.carecompapp.com/onboarding/get-code-of-ethics/APPLICATION_ID
```
...
curl -X POST https://api.carecompapp.com/onboarding/save-service-delivery-policy \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
curl -X GET https://api.carecompapp.com/onboarding/get-service-delivery-policy/APPLICATION_ID
```
...
curl -X POST https://api.carecompapp.com/onboarding/save-non-compete-agreement \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
curl -X GET https://api.carecompapp.com/onboarding/get-non-compete-agreement/APPLICATION_ID
```
...
curl -X GET https://api.carecompapp.com/onboarding/get-background-check/APPLICATION_ID
```
...
curl -X POST https://api.carecompapp.com/onboarding/save-tb-symptom-screen \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
curl -X GET https://api.carecompapp.com/onboarding/get-tb-symptom-screen/APPLICATION_ID
```
...
curl -X POST https://api.carecompapp.com/onboarding/save-orientation-checklist \
  -H "Content-Type: application/json" \
  -d '{
    "applicationId": "APPLICATION_ID_HERE",
    "employeeId": "EMPLOYEE_ID_HERE",
...
curl -X GET https://api.carecompapp.com/onboarding/get-orientation-checklist/APPLICATION_ID
```
...
curl -X PUT https://api.carecompapp.com/onboarding/submit-application/APPLICATION_ID
```
...
curl -X PUT https://api.carecompapp.com/onboarding/update-status/APPLICATION_ID \
  -H "Content-Type: application/json" \
  -d '{
    "status": "under_review",
...
curl -X GET https://api.carecompapp.com/onboarding/get-all-applications
```
...
```bash
# Check server status
curl https://api.carecompapp.com/
