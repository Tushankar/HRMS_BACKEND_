...
// CNA Job Description Schema (Exhibit 1b)
const CNAJobDescriptionSchema = new mongoose.Schema(
  {
    applicationId: {
    ...
    jobTitle: {
      type: String,
      default: "Certified Nursing Assistant",
    },
    exhibitNumber: {
      type: String,
      default: "1b",
...
module.exports = mongoose.model("CNAJobDescription", CNAJobDescriptionSchema);
