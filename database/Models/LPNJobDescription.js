...
// LPN Job Description Schema (Exhibit 1c)
const LPNJobDescriptionSchema = new mongoose.Schema(
  {
    applicationId: {
    ...
    jobTitle: {
      type: String,
      default: "Licensed Practical Nurse",
    },
    exhibitNumber: {
      type: String,
      default: "1c",
...
module.exports = mongoose.model("LPNJobDescription", LPNJobDescriptionSchema);
