...
- Server running on `https://hrms-backend-h16p.onrender.com`
...
**Method:** `GET`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/get-application/67e0f8770c6feb6ba99d11d2`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-employment-application`  
...
**Method:** `GET`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/get-employment-application/YOUR_APPLICATION_ID`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-job-description`
...
**Method:** `PUT`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/supervisor-sign-job-description/JOB_DESC_ID`
...
**Method:** `GET`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/get-job-description/YOUR_APPLICATION_ID/RN`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-i9-form`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-w4-form`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-w9-form`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-emergency-contact`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-direct-deposit`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-misconduct-statement`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-code-of-ethics`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-service-delivery-policy`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-non-compete-agreement`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-background-check`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-tb-symptom-screen`
...
**Method:** `POST`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/save-orientation-checklist`
...
**Method:** `PUT`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/submit-application/YOUR_APPLICATION_ID`

### 9.2 Get All Applications (HR View)

**Method:** `GET`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/get-all-applications`

### 9.3 Update Application Status (HR)

**Method:** `PUT`  
**URL:** `https://hrms-backend-h16p.onrender.com/onboarding/update-status/YOUR_APPLICATION_ID`
