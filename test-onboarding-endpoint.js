...
async function testOnboardingEndpoint() {
  try {
    ...
    console.log('URL:', `http://localhost:1111/onboarding/get-application/${sampleEmployeeId}`);
    
    const response = await axios.get(`http://localhost:1111/onboarding/get-application/${sampleEmployeeId}`, {
      timeout: 10000
    });
